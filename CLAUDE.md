...
- Do not add positioning styles (margin, padding, absolute/relative positioning) or top-level animations to reusable components. These should always be set where the component is used.
